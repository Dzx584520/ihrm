    ...
    <div class="app-container">
      ...
      <el-card shadow="never" class="boxMar">
        <el-table :data="dataList" fit style="width: 100%;" border>
          <el-table-column align="center" type="index" :index="1" label="序号" width="100"> </el-table-column>
          <el-table-column align="center" sortable prop="username" label="姓名" width="150"></el-table-column>
          <el-table-column align="center" sortable prop="mobile" label="手机号" width="150"></el-table-column>
          <el-table-column align="center" sortable prop="workNumber" label="工号" width="120"></el-table-column>
          <el-table-column align="center" sortable prop="formOfEmployment" label="聘用形势" width="200"></el-table-column>
          <el-table-column align="center" sortable prop="departmentName" label="部门" width="200"></el-table-column>
          <el-table-column align="center" sortable prop="timeOfEntry" label="入职时间" width="160">
            <template slot align="center"  slot-scope="scope">
              <span>{{ scope.row.timeOfEntry | FormatDate('yyyy-MM-dd HH:mm:ss') }}</span>
            </template>
          </el-table-column>
          <el-table-column align="center" sortable label="状态" prop="enableState" width="120">
...
import {list,remove,updateStatusById} from "@/api/base/users"
...
export default {
  ...
  methods: {
    ...
    handleStatus(res){
      console.log('res',res)
      updateStatusById({id: res.id}).then(res=>{
